...
total_times_algo2 = np.genfromtxt('total_time_original.txt')
...
ax1.plot(episode_numbers_avg, total_times_avg_algo1, label='Time A_C', color='b', marker='s')
ax1.plot(episode_numbers_avg, total_times_avg_algo2, label='Time Ori', color='g', marker='^')
...
fig.savefig('Time per Episode for Two Algorithms', dpi=300)
